...
(custom-set-variables
 ...
 '(package-selected-packages
   '(js-mode typescript-mode tree-sitter-langs tree-sitter treesitter treemacs-magit treemacs-icons-dired treemacs-projectile treemacs-evil treemacs yaml-mode ledger-mode format-all magit ivy-prescient which-key use-package rainbow-delimiters nix-mode ivy-rich hydra helpful general evil-collection doom-themes doom-modeline counsel-projectile command-log-mode all-the-icons))
 '(prescient-filter-method '(literal regexp initialism fuzzy))
 '(warning-suppress-log-types '((comp) (comp) (comp) (use-package)))
 '(warning-suppress-types '((auto-save) (comp) (comp) (comp) (use-package))))
(custom-set-faces
